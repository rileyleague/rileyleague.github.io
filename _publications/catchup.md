...
with Dylan Fitz<br>
Under Review<br>
Recent draft available [here](http://rileyleague.github.io/files/catchup_leaguefitz.pdf). BibTeX citation available [here](http://rileyleague.github.io/bibfiles/league2022early.md).<br>
A replication package is avaiable [here](http://rileyleague.github.io/files/catchup_code.zip). The replication package relies on data provided by Brazil's Minist\'erio do Desenvolvimento Social e Combate a Fome and publicly available data found [here](https://www.dropbox.com/s/ujak7evtavphnv8/MunicipalRainfall.zip?dl=0).
